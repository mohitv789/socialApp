...
/** @nocollapse */ NgImageSliderService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
/** @nocollapse */ NgImageSliderService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderService, decorators: [{
            type: Injectable
...
/** @nocollapse */ SliderLightboxComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: SliderLightboxComponent, deps: [{ token: i0.ChangeDetectorRef }, { token: i2.DomSanitizer }, { token: i0.ElementRef }, { token: DOCUMENT }], target: i0.ɵɵFactoryTarget.Component });
...
/** @nocollapse */ NgImageSliderComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderComponent, deps: [{ token: i0.ChangeDetectorRef }, { token: PLATFORM_ID }, { token: NgImageSliderService }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Component });
...
/** @nocollapse */ NgImageSliderModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
/** @nocollapse */ NgImageSliderModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderModule, declarations: [NgImageSliderComponent,
        SliderCustomImageComponent,
        SliderLightboxComponent], imports: [CommonModule], exports: [NgImageSliderComponent] });
/** @nocollapse */ NgImageSliderModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderModule, providers: [
        NgImageSliderService
    ], imports: [CommonModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgImageSliderModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule
